...
colorama.init()
COLORS = {0: Fore.BLUE, 1: Fore.CYAN, 2: Fore.GREEN, 3: Fore.MAGENTA, 4: Fore.RED, 5: Fore.WHITE, 6: Fore.YELLOW, 7: Fore.LIGHTRED_EX, 8: Fore.LIGHTMAGENTA_EX, 9: Fore.LIGHTBLUE_EX, 10: Fore.LIGHTCYAN_EX, 11: Fore.LIGHTGREEN_EX, 12: Fore.LIGHTYELLOW_EX, 13: Fore.LIGHTWHITE_EX}
...
def balanced_cluster(embs, num_levels, devices, num_random_clusters=-1, verbose=True):
    ...
    m = embs.shape[0]
    print("type of embeddings are:", type(embs))
    ...
    if(num_random_clusters > 0):
        ...
        print("Clusters to create randomly in balanced_cluster are a valid power of 2...")
